...
import cn.superion.materialDept.receive.receiveOther.view.ReceiveOtherFilter;
import cn.superion.materialDept.receive.receiveOther.view.ReceiveOtherQueryCon;
...
//菜单号
private const MENU_NO:String="0103";
//是否允许零出库
...
{
	parentDocument.title="其他入库处理";
	//  显示组件：打印，输出，增加，修改，删除，保存，放弃，审核，增行，删行，查询，首张，上一张，下一张，末张，退出	
	iaryDisplays=[btToolBar.btPrint, btToolBar.btExp, btToolBar.imageList1, btToolBar.btAdd, btToolBar.btModify, btToolBar.btDelete, btToolBar.btCancel, btToolBar.btSave, btToolBar.btVerify, btToolBar.imageList2, btToolBar.btAddRow, btToolBar.btDelRow, btToolBar.imageList3, btToolBar.btQuery, btToolBar.imageList5, btToolBar.btFirstPage, btToolBar.btPrePage, btToolBar.btNextPage, btToolBar.btLastPage, btToolBar.imageList6, btToolBar.btExit];
	//  可用组件：增加，查询，退出
...
protected function btToolBar_saveClickHandler(event:Event):void
{
	...
	if (laryMaterialRdsDetails.length == 0)
	{
	...
	ro.saveOtherRds(imaterialRdsMasterDept, laryMaterialRdsDetails);
}
