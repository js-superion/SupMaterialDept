...
import cn.superion.materialDept.stat.currentAccountStat.view.WinCurrentAccountStatQuery;
...
//服务类
public const DESTINATION:String='deptCurrentAccountStatImpl';
public const MENU_NO:String="0502";
...
{
	this.parentDocument.title="流水账查询";
	initToolBar();
}
...
{
	var dataList:ArrayCollection=gdCurrentAccount.dataProvider as ArrayCollection;
	...
	if (printSign == '1')
	{
		ReportPrinter.LoadAndPrint("report/materialDept/stat/currentAccountStat.xml", dataList, dict);
	}
	else
	{
		ReportViewer.Instance.Show("report/materialDept/stat/currentAccountStat.xml", dataList, dict);
	}
}
...
{
	var queryWin:WinCurrentAccountStatQuery=PopUpManager.createPopUp(this, WinCurrentAccountStatQuery, true) as WinCurrentAccountStatQuery;
